...
class Document():
    ...
    def load(self, filename: pathlib.Path) -> None:
        ...
        valid_extensions = [".jpg", ".jpeg", ".png", ".tiff", ".pdf"]
    ...
    def add_transformations_to_page(
        self,
        page: int,
        transformations: TransformerResult
    ) -> None:
        """
        Draw rectangles over sensitive data and add the replacement text.
        """
    ...
    def _add_text_to_rectangle(
        ...
        """
        Add text to a rectangle on an image. The font size is chosen in order
        to fit the text into the rectangle.
        """
        shape = (coordinates.left,
                 coordinates.top,
                 coordinates.left+coordinates.width,
